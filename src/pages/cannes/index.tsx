...
export default function Cannes() {
  ...
  const yachtCategories = useMemo<YachtCategory[]>(
    () => [
      {
        id: "cannes-yachts",
        title: "Luxury Yacht Charters in Cannes",
        description:
          "Explore the stunning French Riviera with our exclusive fleet of luxury yachts based in Cannes. Perfect for the Cannes Film Festival, corporate events, or a lavish holiday.",
        yachts: [
          {
            id: "christina-o",
            name: "CHRISTINA O",
      ...
      {
        id: "cannes-day-charters",
        title: "Day Charters from Cannes",
        description:
          "Perfect for day trips to St Tropez, Monaco, or the Lérins Islands, our day charter yachts offer an unforgettable experience on the water.",
        yachts: [
          {
            id: "shadow-900",
            name: "SHADOW 900",
  ...
  return (
    <>
      <Head>
        <title>Yacht Charter Cannes | Luxury Yachts for Rent</title>
        <meta
          name="description"
          content="Charter a luxury yacht in Cannes for the Film Festival, corporate events, or a dream holiday. Explore our exclusive fleet of superyachts and day boats."
        />
      </Head>
      ...
      <div className="min-h-screen bg-white text-gray-900">
        ...
        <section className="relative pt-32 pb-20 overflow-hidden h-screen max-h-[800px] flex items-center">
          ...
          <div className="absolute inset-0 z-0">
            <Image
              src="/photos/StDavid/669296242f10ee15ab68c6c2_St-David-web-images-order.jpg"
              alt="Luxury Yacht in Cannes"
              fill
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-white/90 max-w-2xl mb-10 font-light leading-relaxed">
                Experience the glamour of the French Riviera. Charter a luxury
                yacht for the Cannes Film Festival, a corporate event, or an
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                ...
                >
                  <span>Explore Cannes Fleet</span>
                </a>
                <a
                  href="#cannes-day-charters"
              ...
              <div className="inline-flex items-center gap-2 text-white/80 text-sm">
                <span className="text-white font-medium">
                  Inquire About Charters:
                </span>
                <span>+33 6 75 19 66 98</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="cannes-yachts" className="py-24 bg-white">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          <Link
                            href={`https://wa.me/+33675196698?text=I am reaching out in reference to a yacht charter for ${yacht.name} in Cannes from the Riviera Yachts website.`}
                            target="_blank"
        ...
        <section id="cannes-day-charters" className="py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-light mb-4 tracking-tight">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gray-50 p-8 rounded-lg">
                ...
                <p className="text-gray-600 mb-6 font-light italic">
                  &ldquo;The service was impeccable for the Cannes Film
                  Festival. The crew was attentive, professional, and made our
                  experience was perfect in every way.&rdquo;
                </p>
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs text-gray-500">
                      Cannes Film Festival Charter, May 2023
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-8 rounded-lg">
                ...
                <p className="text-gray-600 mb-6 font-light italic">
                  ...
                  perfectly planned for exploring the coast around
                  Cannes.&rdquo;
                </p>
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-indigo-100 rounded-full flex items-center justify-center text-indigo-500 font-medium flex-shrink-0">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs text-gray-500">
                      Cannes to St Tropez, August 2023
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-8 rounded-lg">
                ...
                <p className="text-gray-600 mb-6 font-light italic">
                  &ldquo;Chartering CHRISTINA O in Cannes was like stepping into
                  a piece of history with all the modern comforts. An
                  unforgettable experience that exceeded all
                  expectations.&rdquo;
                </p>
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-indigo-100 rounded-full flex items-center justify-center text-indigo-500 font-medium flex-shrink-0">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs text-gray-500">
                      Cannes Corporate Event, June 2023
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 bg-gray-900 text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-light mb-6 tracking-tight">
              Ready to Charter a Yacht in Cannes?
            </h2>
              ...
              <div className="bg-white h-auto lg:h-full lg:w-96 lg:absolute lg:right-0 lg:top-0 overflow-y-auto">
                <div className="p-8 lg:p-10">
                  ...
                  <div className="pt-4 border-t border-gray-100">
                    ...
                    <div className="space-y-3">
                      <a
                        href={`https://wa.me/+33675196698?text=I am reaching out in reference to a yacht charter for ${selectedYacht.name} from Cannes from the Riviera Yachts website.`}
                        target="_blank"
                        rel="noopener noreferrer"
